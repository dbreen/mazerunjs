(function() {
  var DIRECTIONS, DIRS, DOWN, LEFT, Maze, Player, RIGHT, TOP, WIDTHS, constants, random_choice, random_color, _ref;
  ...
  Maze = (function() {
    ...
    Maze.prototype.find_neighbors = function(x, y) {
      "Find all x, y pairs in the up/down right/left directions that are still\nwithin the bounds of the grid. Return the directions towards each neighbor";      var dir, idir, neighbors, nx, ny, _i, _len, _ref2;
      neighbors = [];
    ...
    Maze.prototype.grid_to_screen = function(pos) {
      "Convert grid coordinates to screen coordinates";      var ww;
      ww = this.wallwidth;
